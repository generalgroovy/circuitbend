...
for(const required of ['webview.css','webview.js','mathview.css','mathview.js'])if(!fs.existsSync(path.join(root,required)))throw new Error(`Enhanced web asset missing: ${required}`);
...
if(!/m\.src=['"]mathview\.js['"]/.test(projectJs))throw new Error('project.js must load mathview.js with a relative Pages-safe URL');
