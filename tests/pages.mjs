...
for(const required of ['webview.css','webview.js','mathview.css','mathlab.js','streamlined.css','streamlined.js','preview-window.css','preview-window.js','sandbox-runtime.js','sandbox-samples.js'])if(!fs.existsSync(path.join(root,required)))throw new Error(`Enhanced web asset missing: ${required}`);
...
for(const required of ['sandbox-runtime.js','sandbox-samples.js']){
